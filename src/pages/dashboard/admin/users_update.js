...
import UsersUpdate from '@/components/dashboard/admin/content/users_update'
...
export default function UsersUpdatePage() {
    // page default data
    const pageName = "Sky Ink Savings - Admin Dashboard";
    ...
    const baseURL = "https://skyinksavings.com/dashboard/admin";
